...
particlesJS("particles-js", {
    "particles": {
        ...
        "color": {
            "value": ["#ff4081", "#f06292", "#f8bbd0", "#d81b60", "#ff80ab", "#ffcdd2", "#ffd54f", "#ffeb3b"]
        },
        "shape": {
            "type": "circle",
            "stroke": {
...
function createHearts() {
    ...
    const colors = ['#ff4081', '#f06292', '#f8bbd0', '#d81b60', '#ff80ab', '#ffd54f', '#ffeb3b'];
    const shapes = ['❤', '🎈', '🎂', '🎁', '⭐', '✨', '🌟'];
    ...
    // Animate heart click with bounce effect
    ...
    // Create extra celebration burst
    createCelebrationBurst();
}

// Function to create celebration burst
function createCelebrationBurst() {
    const container = document.getElementById('floatingHearts');
    const burstColors = ['#ff4081', '#f06292', '#ffd54f', '#ffeb3b', '#4caf50', '#2196f3'];
    ...
    for (let i = 0; i < 20; i++) {
        ...
        burst.style.fontSize = `${25 + Math.random() * 20}px`;
...
function createPetals() {
    ...
    const petalColors = ['#ffcdd2', '#f8bbd0', '#fce4ec', '#f48fb1', '#ffd54f', '#ffeb3b', '#c8e6c9'];
...
function typeMessage() {
    const messages = [
        ...
        "I'm so proud of the amazing 4-year-old you are.",
        "May this year bring you all the fun and happiness.",
        "You deserve all the cake and presents!",
        "Happy 4th Birthday, Aarnika! 🎂🎈"
    ];
...
function createFirework() {
    const colors = ['#ff4081', '#f06292', '#f8bbd0', '#d81b60', '#ff80ab', '#ffcdd2', '#ffd54f', '#ffeb3b', '#4caf50', '#2196f3', '#9c27b0'];
    ...
    setTimeout(() => {
        for (let i = 0; i < 40; i++) {
            ...
            particle.style.setProperty('--tx', `${Math.cos(i * 0.15) * 150}px`);
            particle.style.setProperty('--ty', `${Math.sin(i * 0.15) * 150}px`);
